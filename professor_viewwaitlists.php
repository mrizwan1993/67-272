...
<h2 id = "heading"> View Your Waitlisted Students </h2>
<br/><br/>
<br/>
...
WHERE sse.sectionID = s.sectionID AND s.professorID = '$user' AND sse.enrollmentStatus = 0
...
echo "<h2 id = 'heading'>No waitlisted students in your courses</h2>";
}
