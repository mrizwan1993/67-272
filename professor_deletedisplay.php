...
<h2 id = "heading"> List for deleting Professors </h2>

<?php
//sql statement to select all professors
...
echo "<tr><td> " . $row["andrewID"]. "  </td><td> " . $row["password"]. "  </td><td> " . $row["firstName"]. 
"  </td><td> " . $row["lastName"].  " </td><td> " . $row["rank"]. "  </td><td> " .  $row["dateOfBirth"] . 
" </td><td> "  . $row["contactInfo"] . "</td><td>"  . $row["isAdvisor"] . 
"</td><td><a href='professor_delete.php?id=" . $row["andrewID"] . "'>Delete Professor Record</a></td></tr>";
